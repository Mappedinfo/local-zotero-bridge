...
Attach `release/local-zotero-bridge-0.2.15.xpi` to the GitHub release `v0.2.15`, then keep `updates.json` on the default branch so Zotero can check for updates.
